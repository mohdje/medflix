...
## How to use it
If you want to use the full version of Medflix to watch movies, donwload a release from the Releases section. There is a web application (to access it throw web browser and share it to other devices of the same network) and a Windows application.
