import "../../style/css/video-player.css";
...
function VideoPlayer({ videoQualitiesOptions, videoSubtitlesOptions, onWatchedTimeUpdate, videoTime }) {
    ...
    useFadeTransition(videoPlayerControlsContainerRef, showVideoControls);
    ...
    return (
        <div ref={videoPlayerContainerRef} className="video-player-content" >
            <CircularProgressBar size={'x-large'} position={"center"} visible={videoSource && videoIsLoading} text={videoDownloadState} />
            ...
            <div className="video-player-bottom">
                ...
                <div ref={videoPlayerControlsContainerRef} className="video-player-controls-container">
                    <TimeController
